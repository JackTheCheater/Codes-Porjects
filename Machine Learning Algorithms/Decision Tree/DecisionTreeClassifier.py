...
class DecisionTreeClassifier:
    ...
    def train(self): # starts the algorithm
    ...
    def getMaxDepth(self): # returns the height of the tree
        return self.__root.getMaxDepth()
    
    def getBalance(self): # abs balance of the tree
...
class Node:
    ...
    def getBalance(self): # get the height of the children
    ...
    def __mostCommonClass(self, Y): # returns the most common class and the class distribution of the node
...
class Gini(Node):
    ...
    def __gini(self, Y): # average amount of information needed to identify the class label of a tuple in X
